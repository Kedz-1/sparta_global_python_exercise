...
def test_load_json_returns_list(tmp_path, test_data):
...
def test_load_json_has_correct_headers(tmp_path, test_data):
    ...
    for header in headers:
        assert header in ['name', 'height', 'mass', 'hair_color', 'skin_color', 'eye_color', 'birth_year', 'gender', 'homeworld', 'films', 'species']
