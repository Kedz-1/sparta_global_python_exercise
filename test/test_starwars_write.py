import pytest
from src.star_wars_characters import load_json
from src.star_wars_characters import write_csv
import csv
import json
...
def test_write_csv(tmp_path, test_data):
    ...
    result = write_csv(data, output_file)
